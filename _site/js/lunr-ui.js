$.getJSON("http://localhost:4000/wax-bofh-demo/js/lunr-index.json", function(index_json) {
  ...
  $('input#search').on('keyup', function() {
    ...
    for (var r in results) {
      ...
      if ('thumbnail' in item) {
        var thumb = `<img class='sq-thumb-sm' src='http://localhost:4000/wax-bofh-demo${item.thumbnail}'/>&nbsp;&nbsp;&nbsp;`
      }
      else {
        var thumb = '';
      }
